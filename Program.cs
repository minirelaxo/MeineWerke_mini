...
namespace MyApp
{
    ...
    class Program
    {
            ...
            {   
                ...
                Console.WriteLine("4-Server_Starten");
                Console.WriteLine("5-Server_Bearbeiten");
                    ...
                    case 2:
                        ...
                        switch (ram_10)
                        {
                            ...
                            case 3:
                                ...
                                Console.WriteLine("welche version willst du benutzen?");
                                string ? versionInput = Console.ReadLine();

                                Console.WriteLine("welche Software willst du benutzen?");
            ...
            //muss noch gemacht werden
                        break;
                    case 3:
                        Console.WriteLine("welcher server soll gelöscht werden?");
                        string? serverToDelete = Console.ReadLine();
                        Console.WriteLine($"Server '{serverToDelete}' wird gelöscht.");
                        break;

                    case 4:
                        Console.WriteLine("welcher server soll gestartet werden?");
                        string? serverToStart = Console.ReadLine();
                        Console.WriteLine($"Server '{serverToStart}' wird gestartet.");
                        break;
                    case 5:
                        Console.WriteLine("welcher server soll bearbeitet werden?");
                        string? serverToEdit = Console.ReadLine();
                        Console.WriteLine($"Server '{serverToEdit}' wird bearbeitet.");
                        break;
                    default:
                        Console.WriteLine("Ungültige Auswahl.");
                        break;
